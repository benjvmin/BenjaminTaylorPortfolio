	...
	section.project-single-wrapper
		...
		div.project-single(v-if="complete")
			...
			.project-capsule
				...
				.project-images
					.project-images__image(:style="{ backgroundImage: `url('${project.acf.project_image_one.url}')`}")
					.project-images__image(:style="{ backgroundImage: `url('${project.acf.project_image_two.url}')`}")
